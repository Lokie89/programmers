...
public class Solution {
    ...
    public String solution(String new_id) {
        answer = new_id;
        try {
            validateIdLength(answer);
            validateSpecialString(answer);
            validateDot(answer);
    ...
    private void validateSpecialString(String id) {
    ...
    private void validateDot(String id) {
        if (id.substring(0, 1).equals("\\.")
                || id.substring(id.length() - 1).equals("\\.")
                || id.contains("\\..")) {
            throw new RuntimeException();
        }
    }
    ...
    private void recommend5() {
        if (answer.equals("")) {
            answer = "a";
        }
    }

    private void recommend6() {
        if (answer.length() > 15) {
